#IMPLIED NIL
#
# Let's implement a simple search feature - for our naive implementation,
# we search for a game by its exact title, and if it's found, we show it.
# Comparing something with nil in an if statement isn't needed in Ruby.
# Refactor the code below to run without the nil comparison.
